...
We will test reading to the S3 Bucket with the urban targets data, but I have
included the urls for all 3.

```{r}
base_url = 'https://minio-s3.apps.shift.nerc.mghpcc.org/bu4cast-ci-read/challenges/project_id=bu4cast/targets/'
urban_url = paste(base_url, 'urban-targets.csv', sep = "")
disease_url = paste(base_url, 'tropical-disease-targets.csv', sep = "")
coastal_url = paste(base_url, 'coastal-targets.csv', sep = "")
...
```{python}
base_url = 'https://minio-s3.apps.shift.nerc.mghpcc.org/bu4cast-ci-read/challenges/project_id=bu4cast/targets/'
urban_url = base_url + 'urban-targets.csv'
disease_url = base_url + 'tropical-disease-targets.csv'
coastal_url = base_url + 'coastal-targets.csv'
...
url <- paste0("https://minio-s3.apps.shift.nerc.mghpcc.org/bu4cast-ci-write/challenges/project_id=bu4cast/forecasts/", challenge_name_example, "/",team_name_example, "-submission.csv")
...
challenge_name_example = 'test'
team_name_example = 'KAIYA' ## FILL IN WITH YOUR OWN TEAM NAME EXAMPLE
url = f"https://minio-s3.apps.shift.nerc.mghpcc.org/bu4cast-ci-write/challenges/project_id=bu4cast/forecasts/{challenge_name_example}/{team_name_example}-submission.csv"
