...
noaa_theme_df <- arrow::open_dataset(arrow::s3_bucket("bio230014-bucket01/neon4cast-drivers/noaa/gefs-v12/stage2", endpoint_override = config$noaa_endpoint, anonymous = TRUE))
