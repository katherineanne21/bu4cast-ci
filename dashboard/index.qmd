...
all_forecasts <- arrow::open_dataset("../cache/summaries") |> 
n_forecasts <- arrow::open_dataset(all_forecasts) |> distinct(model_id, duration, reference_date) |> collect() |> nrow()
n_models <- arrow::open_dataset(all_forecasts) |> distinct(model_id, duration, variable) |> collect() |> nrow()
