...
After submission, our servers will process uploaded files by converting to a parquet on our public s3 storage.  A `pub_datetime` column will be added that denotes when a forecast was submitted.  

All forecasts are scored daily using new data until the full horizon of the forecast has been scored.  

Information for accessing the forecasts and scores can be found on our @sec-stac.
