...
### Any approach but be sure in include uncertainty

You can use any approach to make a prediction about the future conditions at the two reservoirs or the stream.  We require that predictions include uncertainty that is either represented using a distribution or numerically using an ensemble (or sample) of predictions. 
...
Forecasts can be submitted for 1 to 10 years ahead.  
...
After submission, our servers will process uploaded files by converting to a parquet on our public s3 storage.
