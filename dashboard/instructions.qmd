...
If are you are getting started, we recommend a set of focal sites for each of the five "themes". See [here](targets.qmd#sec-starting-sites) for the list. You are also welcome to submit forecasts to all NEON sites.
