...
An introductory tutorial for submitting to Challenge focused on aquatics theme: [https://github.com/eco4cast/NEON-forecast-challenge-workshop](https://github.com/eco4cast/NEON-forecast-challenge-workshop). [A webinar version of tutorial](https://www.youtube.com/watch?v=-5iPNr19g-4)

An introduction to forecast evaluation: [https://github.com/OlssonF/Forecast-evaluation-EFI25](https://github.com/OlssonF/Forecast-evaluation-EFI25)

More advanced tutorial for submitting to Challenge focused on the terrestrial theme: [https://github.com/rqthomas/FluxCourseForecast](https://github.com/mdietze/FluxCourseForecast)
...
Malmborg, C. A., Willson, A. M., Bradley, L. M., Beatty, M. A., Klinges, D. H., Koren, G., Lewis, A. S. L., Oshinubi, K., & Woelmer, W. M. 2024. Defining model complexity: An ecological perspective. Meteorological Applications, 31(3), e2202. <https://doi.org/10.1002/met.2202>
...
### Details about the data standards used in the challenge
