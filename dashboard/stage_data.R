...
s3_summaries_P1D <- open_dataset(paste0("s3://", config$summaries-bucket, "/project_id=", config$project_id,"/duration=P1D/"), s3_endpoint = config$endpoint, anonymous = TRUE)
...
s3_summaries_P1W <- open_dataset(paste0("s3://", config$summaries-bucket, "/project_id=", config$project_id,"/duration=P1W/"), s3_endpoint = config$endpoint, anonymous = TRUE)
