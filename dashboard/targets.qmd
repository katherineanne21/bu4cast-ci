...
The targets are updated daily as new NEON is made available. 
...
- "duration" is the time-step of the variable where `PT30M` is a 30-minute mean, `P1D` is a daily mean, and `P1W` is a weekly mean. 
- The "forecast horizon" is the number of days-ahead that we want you to forecasts. 
