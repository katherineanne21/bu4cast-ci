...
The NEON Ecological Forecasting Challenge is a powerful resource for teaching. We encourage courses to have students submit to the challenge as projects in traditional courses or training workshops.
...
-   Use available resources: We have created workshop materials that teach all the key steps for generating, submitting, and automating forecasts (https://github.com/eco4cast/NEON-forecast-challenge-workshop).  The materials have been peer-reviewed and published at [Olsson et al. 2024.](https://doi.org/10.21105/jose.00259).
...
## Materials for use courses that have used the challenge
