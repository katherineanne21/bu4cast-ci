...
s3_df <- get_grouping(inv_bucket = 'neon4cast-forecasts', theme = "vera4cast_daily") # inv_bucket will need to change
...
build_forecast_scores(table_schema = theme_df,
                      ...
                      destination_path = "stac/vera4cast-subdaily/forecasts/",
                      aws_download_path = 'neon4cast-scores/forecasts/vera4cast-subdaily')
